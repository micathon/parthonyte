...
* Sister language called Trinotext is like HTML, also used for config files
* Trinodec is easier to learn than most of the popular languages, but somewhat less practical
